class IAS_processor:
    ...
    def decode_cycle(self):
        left_instruction = (
            self.MBR >> 20
        )  # Gettting the first 20bits for left instruction from MBR
        right_instruction = (
            self.MBR & 0b1111_1111_1111_1111_1111
        )  # Getting the last 20bits for right instruction from MBR

        self.IR = left_instruction >> 12  # Getting the first 8bits ie opcode
        self.MAR = (
            left_instruction & 0b1111_1111_1111
        )  # Getting the last 12bits for adress
    ...
    def execute_cycle(self):
        ...
        # Adress modify instructions
            ...
            right_instruction = self.MBR & 0b1111_1111_1111_1111_1111
            left_instruction = (left_instruction & 0b0000_0000_0000) | (
                self.AC & 0b1111_1111_1111
            )
